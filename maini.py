...
stream = cv2.VideoCapture("sharik.mp4")
flag = True
def play(speed):
    global flag
    print(f"you clicked on play . Speed in {speed}")
...
window = tkinter.Tk()
window.title("Sharik Third umpire Decision Review Kit")
